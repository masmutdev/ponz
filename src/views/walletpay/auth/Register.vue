<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-transparent px-4">
    <div class="w-full max-w-xs">
      <div class="flex flex-col items-center mb-8">
        <img
          alt="Yellow wallet icon with a small circle button on the right side"
          class="mb-2"
          height="200"
          src="@/assets/1/new-wallet.png"
          width="200"
        />
      </div>
      <form class="space-y-3" @submit.prevent="register">
        <p class="text-xs text-[#0B1E4F] mb-1 font-semibold">Buat Akun mitra Wallet Pay Business</p>
        <input
          v-model="nama"
          class="w-full rounded-full py-2 px-4 text-sm text-[#0B1E4F] placeholder-[#0B1E4F] bg-white focus:outline-none"
          placeholder="Name"
          type="text"
        />
        <input
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            <canvas ref="captchaCanvas" width="150" height="50" class="rounded bg-transparent" />
            <button
              type="button"
              @click="generateCaptcha"
              class="ml-3 bg-[#FF7F7F] text-[#B30000] text-xs font-bold rounded-full px-3 py-0.5"
            >
              Refresh
            </button>
          </div>
          ...
          <input
            ...
            class="w-full rounded-full py-2 px-4 pr-20 text-sm text-[#0B1E4F] placeholder-[#0B1E4F] bg-white focus:outline-none"
  ...
  <Transition name="fade">
    ...
    >
      <div
        class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full shadow-lg animate-fade-in h-full overflow-y-scroll"
      >
        <h3 class="text-lg font-bold text-center text-blue-900 dark:text-white mb-3">
          {{ showModal === 'terms' ? 'Ketentuan Layanan' : 'Kebijakan Privasi' }}
        </h3>
        <article class="prose prose-blue max-w-none">
          <h1 class="text-4xl font-extrabold mb-4">Privacy Policy for WALLET PAY</h1>
          <p class="text-gray-600 font-semibold mb-8">Last updated: June 27, 2025</p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              refers to WALLET PAY, accessible from
              <a
                class="text-blue-600 hover:underline"
                href="https://service-walletpaybusiness101.cloud"
              >
                https://service-walletpaybusiness101.cloud
              </a>
            </li>
            <li>
              <strong> You </strong>
          ...
          <ul class="list-disc list-inside mb-16">
            <li>
              By email:
              <a class="text-blue-600 hover:underline" href="mailto:support@walletpay.com">
                support@walletpay.com
              </a>
            </li>
            <li>
              ...
              <a
                class="text-blue-600 hover:underline"
                href="https://walletpaybusiness101.cloud/contact"
              >
                https://walletpaybusiness101.cloud/contact
              </a>
            </li>
            <li>
              By phone number:
              <a class="text-blue-600 hover:underline" href="tel:+85223456789"> 85223456789 </a>
            </li>
          </ul>
        </article>

        <div class="mt-4 text-center">
          <button @click="showModal = ''" class="text-sm text-blue-600 underline">Tutup</button>
        </div>
      </div>
    </div>
  </Transition>
...
const showModal = ref<'terms' | 'privacy' | ''>('')
...
const register = async () => {
  ...
  if (!nama.value || !email.value || !hp.value || !password.value) {
